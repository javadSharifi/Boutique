...
function ListIconCategories() {
  ...
  return (
    <div className="w-full grid grid-cols-3 px-5 sm:flex  justify-center gap-4 sm:gap-10 md:gap-14 lg:gap-28  items-center  ">
      {iconCategories.map(({ icon, name }) => (
        <Link key={name} href={name} className="flex flex-col justify-center items-center">
